...
export function Footer({currentPage = 'footer', onNavigate }: FooterProps) {
 const { campus, setCampus } = useCampus();
  ...
  const iframeSrc = campus === 'playschool'
    ? "https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3792.3605572003453!2d83.42991857518156!3d18.101133482912907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTjCsDA2JzA0LjEiTiA4M8KwMjUnNTcuMCJF!5e0!3m2!1sen!2sin!4v1773481842380!5m2!1sen!2sinhttps://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3792.393755003332!2d83.4309001!3d18.099599!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3bfb373ba1de61%3A0x78421c12599dd93b!2sOakland%20Early%20Explorers%20School!5e0!3m2!1sen!2sin!4v1764833798788!5m2!1sen!2sin"
    : "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3792.6313178065143!2d83.5440702!3d18.088614600000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3bf91f1ec5ac39%3A0xf53ec6ee75de1502!2sOAKLAND%20ENGLISH%20MEDIUM%20SCHOOL!5e0!3m2!1sen!2sin!4v1764833386582!5m2!1sen!2sin";
  return (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/oakexp" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.facebook.com/profile.php?id=61574468833926&mibextid=wwXIfr&rdid=JebAE3g4HocwP9Jj&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1JefjURpVV%2F%3Fmibextid%3DwwXIfr#"
                className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.youtube.com/@oaklandschoolsvzm?si=0qzeUqcKx2feThRQ"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.page}>
                  <button onClick={() => onNavigate(link.page)} className="text-gray-400 hover:text-white transition-colors">
                    {link.label}
                  </button>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="tel:+919121009935" className="flex items-start space-x-3 text-gray-400 hover:text-white transition-colors">
              ...
              <div className="flex items-start space-x-3 text-gray-400">
                ...
                <div>
                  <p className="mb-1">Jammu, Padalpeta Road, near Srinivasa Function Hall</p>
      ...
      <div className="bg-gray-950 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-500 text-sm">
            ...
            {' • '}
            <a href="https://www.instagram.com/oaklschool" target="_blank" rel="noopener noreferrer"
